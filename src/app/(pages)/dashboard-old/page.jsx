...
export default function Dashboard() {
  ...
  const autoSaveJournal = useCallback(
    ...
    [todayJournal, checkedRules]
  );

  // Update handleJournalChange to trigger auto-save
  ...
  // Update toggleSelectRule to trigger auto-save when rules are checked/unchecked
